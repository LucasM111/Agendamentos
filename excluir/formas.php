<?php
    ...
    $sqlVenda = "select id from vendas where formas_id = :id limit 1";
    ...
    if (!empty($dados->id)) {
        mensagem("Erro","Esta forma não pode ser excluída pois existe uma venda utilizando o registro");
    }

    //excluir o registro
    $sqlExcluir = "delete from formas where id = :id limit 1";
